...
router.get("/:userId", userMiddleware_1.userMiddleware.isValidUserCreate, userMiddleware_1.userMiddleware.getByIdThrow, userController_1.userController.getById);
